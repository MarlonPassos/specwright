...
const VERIFY_INSTRUCTION = [
  ...
  '   como NÃO VERIFICADO.',
  '4. Quando a change está vinculada a um incremento, confira que cada critério macro do',
  '   brief tem ao menos uma tarefa que o exerça, e diga qual.',
  '5. Procure desvio nos dois sentidos: comportamento que nenhuma spec descreve, e',
  '   requisito que ninguém construiu.',
  '6. Grave `verification.md` no diretório da change, seguindo o template devolvido aqui.',
  '',
